...
import omOsUrl from "@/assets/nemsyn-hal-new.png";
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        <ScrollReveal>
          ...
          <h2 className="mt-3 text-3xl font-extrabold text-foreground sm:text-4xl">
            Lokal synshal i Lind, hvor det er nemt at komme til
          </h2>
          <p className="mt-5 text-base leading-relaxed text-muted-foreground">
            NemSyn ApS er en moderne synshal på Nr. Lindvej 1 i Herning, der kombinerer drive-in med mulighed for booking. Høj teknisk faglighed, gennemsigtighed og kvalitet er fundamentet for vores service.
          </p>
          <p className="mt-4 text-base leading-relaxed text-muted-foreground">
            Uanset om det drejer sig om periodisk syn, registreringssyn, toldsyn eller omsyn, sørger vi for et nemt og trygt bilsyn for dig og dit køretøj.
          </p>
          ...
          <ul className="mt-8 space-y-4">
            ...
            <li className="flex gap-4">
              ...
              <div className="min-w-0">
                <p className="font-semibold text-foreground">Faglighed</p>
