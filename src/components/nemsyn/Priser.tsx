...
const groups: { title: string; items: { name: string; detail: string; price: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Personbil", detail: "Syn / omsyn / lille omsyn", price: "599 / 349 / 199 kr" },
      { name: "Varebil", detail: "Syn / omsyn / lille omsyn", price: "599 / 349 / 199 kr" },
      { name: "Motorcykel", detail: "Syn / omsyn", price: "399 / 349 kr" },
      { name: "Påhængskøretøj op til 750 kg", detail: "Syn / omsyn", price: "399 / 299 kr" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Nummerplade", detail: "1 stk.", price: "850 kr" },
